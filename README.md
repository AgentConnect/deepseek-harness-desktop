...
| 平台 | 下载 | 安装方式 |
| --- | --- | --- |
| Windows x64 | [下载安装程序](https://awiki.me/downloads/dsh-awiki/) | 运行 NSIS 安装程序并按提示完成安装 |
| macOS Universal | [下载 DMG](https://awiki.me/downloads/dsh-awiki/) | 打开 DMG，将 DSH Desktop 拖入 Applications |
