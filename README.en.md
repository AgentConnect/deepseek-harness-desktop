...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p>Connect to Desktop from iOS and Android to start tasks, monitor Agent progress, and send follow-ups from your phone. Included in version 2.0.9 and later.</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
