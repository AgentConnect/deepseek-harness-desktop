  ...
  try {
    ...
    if (process.env.DSH_DESKTOP_ISOLATED_HOST !== '0') {
      ...
      await startIsolatedDesktopHost({
        ...
        awikiUpdates, runtime, rendererToken: browserAccess.rendererHeader.value,
      ...
      startupStage = 'host-boot'
      lifecycleRecorder.transitionStartupStage(startupStage)
      const releasePackageResolver = installProfilePackageResolver(prepared.bareModuleBaseUrl, prepared.packageSourceOverrides)
